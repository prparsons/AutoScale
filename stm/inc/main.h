...
#define CELL_DAT_Pin GPIO_PIN_0
#define CELL_DAT_GPIO_Port GPIOC
#define CELL_CLK_Pin GPIO_PIN_1
#define CELL_CLK_GPIO_Port GPIOC
#define ST0_M3_Pin GPIO_PIN_2
#define ST0_M3_GPIO_Port GPIOC
#define ST0_STBY_Pin GPIO_PIN_0
#define ST0_STBY_GPIO_Port GPIOA
#define ST2_EN_Pin GPIO_PIN_3
#define ST2_EN_GPIO_Port GPIOA
#define CS_Pin GPIO_PIN_4
#define CS_GPIO_Port GPIOA
#define ST2_M3_Pin GPIO_PIN_4
#define ST2_M3_GPIO_Port GPIOC
#define RST_Pin GPIO_PIN_5
#define RST_GPIO_Port GPIOC
#define DC_Pin GPIO_PIN_0
#define DC_GPIO_Port GPIOB
#define ST2_STBY_Pin GPIO_PIN_1
#define ST2_STBY_GPIO_Port GPIOB
#define ST2_M1_Pin GPIO_PIN_12
#define ST2_M1_GPIO_Port GPIOB
#define ST2_M2_Pin GPIO_PIN_13
#define ST2_M2_GPIO_Port GPIOB
...
#define ST2_M0_Pin GPIO_PIN_3
#define ST2_M0_GPIO_Port GPIOB
